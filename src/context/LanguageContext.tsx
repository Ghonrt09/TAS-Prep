...
const translations = {
  ru: {
    ...
    timerMinutes: "м",
    timerSeconds: "с",
    heroBadge: "Платформа для 5–6 классов",
    heroTitle: "Готовьтесь к НИШ, БИЛ и РФМШ умнее.",
    heroBody:
      "TAS Prep это удобная подготовительная платформа на которой вы можете подготовиться к вступительным экзаменам в лучшие школы Казахстана. На нашем сайте вы можете найти пробные тесты, банк вопросов и аналитику ваших результатов.",
    ...
    footerContactInstagram: "Instagram: tas.prep",
    footerContactTelegram: "Telegram: TAS Prep",
    footerContactEmail: "Почта: {email}",
    ...
    categoryMatemNisRu: "Математика НИШ (рус)",
    categoryMatemNisRuDesc: "Материалы по математике для подготовки к НИШ.",
    authTitle: "Вход",
    ...
    authDisplayName: "Имя (как в профиле)",
    ...
    heroProof: "Платформа для учеников 5–6 классов по всей стране.",
    homeReviewsTitle: "Отзывы",
    homeReviewsSubtitle: "Что говорят ученики и родители.",
    homeReviewsLink: "Все отзывы",
    forInvestorsTitle: "Для инвесторов и партнёров",
    forInvestorsBody: "TAS Prep — EdTech MVP для подготовки к НИШ, БИЛ и РФМШ. Готовы к демо и обсуждению сотрудничества.",
    forInvestorsCta: "Связаться по почте",
    footerCopyright: "© 2025 TAS Prep. Все права защищены.",
  },
  kk: {
    ...
    timerMinutes: "мин",
    timerSeconds: "с",
    heroBadge: "5–6 сыныптарға арналған Платформа",
    heroTitle: "НИШ, БИЛ және РФМШ емтихандарына ақылды дайындалыңыз.",
    heroBody:
      "TAS Prep сынақ тесттерін, сұрақтар банкін және талдауды бір ыңғайлы платформада біріктіреді.",
    ...
    footerContactInstagram: "Instagram: tas.prep",
    footerContactTelegram: "Telegram: TAS Prep",
    footerContactEmail: "Пошта: {email}",
    ...
    categoryMatemNisRu: "Математика НИШ (орыс)",
    categoryMatemNisRuDesc: "НИШ дайындығына арналған математика материалы.",
    authTitle: "Кіру",
    ...
    authConfirmPassword: "Құпия сөзді қайталаңыз",
    authDisplayName: "Аты (профильде көрінеді)",
    authNoAccount: "Аккаунт жоқ па? Тіркелу",
    authHasAccount: "Аккаунтыңыз бар ма? Кіру",
    ...
    heroProof: "Бүкіл ел бойынша 5–6 сынып оқушыларына арналған платформа.",
    homeReviewsTitle: "Пікірлер",
    homeReviewsSubtitle: "Оқушылар мен ата-аналар не дейді.",
    homeReviewsLink: "Барлық пікірлер",
    forInvestorsTitle: "Инвесторлар мен серіктестер үшін",
    forInvestorsBody: "TAS Prep — НИШ, БИЛ және РФМШ дайындығына арналған EdTech MVP. Демо және ынтымақтастықты талқылауға дайын.",
    forInvestorsCta: "Байланысу",
    footerCopyright: "© 2025 TAS Prep. Барлық құқықтар қорғалған.",
  },
} as const;
