...
export const bankCategories: BankCategory[] = [
  ...
  },
  {
    ...
    file: "Русский Язык НИШ для Рус Школ.json",
    title: "Русский язык НИШ (русские классы)",
    titleKk: "Орыс тілі НИШ (орыс сыныптары)",
    description: "Грамотность чтения с пояснениями к каждому заданию.",
    descriptionKk: "Оқу сауаттылығы, әр тапсырмаға түсіндірме.",
    school: "nis",
    format: "lines",
    questionCount: 40,
  },
  {
    slug: "rus-yaz-ksh-nish",
    file: "Русский Язык НИШ для Каз Школ.json",
    title: "Русский язык НИШ (казахские классы)",
    titleKk: "Орыс тілі НИШ (қазақ сыныптары)",
    description: "Грамотность чтения с пояснениями к каждому заданию.",
    descriptionKk: "Оқу сауаттылығы, әр тапсырмаға түсіндірме.",
    school: "nis",
    format: "lines",
  ...
  {
    slug: "english-nish",
    file: "Английский Язык НИШ.json",
    title: "Английский язык НИШ",
    titleKk: "Ағылшын тілі НИШ",
    description: "Пробный тест по английскому с пояснениями.",
    descriptionKk: "Ағылшын тілі бойынша сынақ тесті, түсіндірмелермен.",
    school: "nis",
    format: "lines",
    questionCount: 39,
  },
  {
    slug: "estestvoznanie-nish",
    file: "Естествознание НИШ.json",
    title: "Естествознание НИШ",
    titleKk: "Жаратылыстану НИШ",
    description: "Пробный тест по естествознанию с пояснениями.",
    descriptionKk: "Жаратылыстану бойынша сынақ тесті, түсіндірмелермен.",
    school: "nis",
    format: "lines",
    questionCount: 35,
  },
