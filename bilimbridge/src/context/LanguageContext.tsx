...
const translations = {
  ru: {
    ...
    practiceHubSubtitle: "Выберите пробный экзамен: НИШ, БИЛ или РФМШ.",
    practiceOpenTrial: "Открыть",
    practiceChooseTrack: "Выберите язык обучения для пробного экзамена",
    practiceTrackRsh: "Русские школы",
    practiceTrackRshHint: "Обучение на русском языке",
    practiceTrackKsh: "Казахские школы",
    practiceTrackKshHint: "Обучение на казахском языке",
    practiceStartTrial: "Начать пробник",
    practiceNavHint:
      "Можно переходить между вопросами вперёд и назад, менять ответы и пропускать задания. Ответы и объяснения — только после завершения всего экзамена.",
    practiceBackToList: "К выбору пробного экзамена",
    practiceTrialNotFound: "Такого пробного экзамена нет.",
    practiceLoading: "Загрузка пробника…",
    practiceProgress: "Прогресс",
    practiceBack: "Назад",
    practiceNext: "Дальше",
    practiceFinish: "Завершить",
    practiceFinishExam: "Завершить экзамен",
    practiceOpenGrid: "Сетка вопросов",
    practiceQuestionGrid: "Сетка вопросов",
    practiceCloseGrid: "Закрыть",
    practiceGridCurrent: "Текущий",
    practiceGridAnswered: "Отвечен",
    practiceGridSkipped: "Без ответа",
    practiceAnswered: "Отвечено",
    practiceResults: "Результаты",
    practiceResultsSubtitle: "Экзамен завершён. Ниже — результат по каждому разделу.",
    practiceReviewWithAnswers: "Разбор с ответами и объяснениями",
    practiceReviewTitle: "Разбор экзамена",
    practiceReviewSkipped: "Пропущен",
    practiceBackToResults: "К результатам",
    practiceSectionScore: "Правильно: {correct} из {total} · отвечено: {answered}",
    ...
    bankFilterAll: "Все",
    bankFilterNis: "НИШ",
    bankFilterRfmsh: "РФМШ",
    bankFilterBil: "БИЛ",
    bankQuestions: "{value} вопросов",
    bankOpen: "Открыть",
    bankQuestionLabel: "Вопрос {number}",
    bankAnswerCorrect: "Верно",
    bankAnswerWrong: "Неверно",
    bankEnterAnswer: "Введите ответ",
    bankAnswerPlaceholder: "Ваш ответ",
    bankCheckAnswer: "Проверить",
    bankExplanationTitle: "Объяснение",
    bankExplanationHint: "Разбор решения и правильный ответ.",
    bankCorrectAnswerLabel: "Правильный ответ:",
    bankHowToSolve: "Как решать",
    bankNoExplanation: "Пояснение к этому заданию пока не добавлено.",
    ...
    profileSubtitle: "Данные и прогресс сохраняются автоматически.",
    profileProgress: "Прогресс",
    profileProgressDesc: "Результаты пробных тестов и активность отображаются здесь.",
    profileCorrect: "Правильно",
    profileIncorrect: "Неправильно",
    profileTotal: "Всего ответов",
    profileNoProgress: "Пройдите пробный тест, чтобы здесь отображался прогресс.",
  ...
  kk: {
    ...
    practiceHubSubtitle: "Сынақ емтиханын таңдаңыз: НИШ, БИЛ немесе РФМШ.",
    practiceOpenTrial: "Ашу",
    practiceChooseTrack: "Сынақ емтиханы үшін оқу тілін таңдаңыз",
    practiceTrackRsh: "Орыс мектептері",
    practiceTrackRshHint: "Орыс тілінде оқу",
    practiceTrackKsh: "Қазақ мектептері",
    practiceTrackKshHint: "Қазақ тілінде оқу",
    practiceStartTrial: "Сынақты бастау",
    practiceNavHint:
      "Сұрақтар арасында алға-артқа өтуге, жауапты өзгертуге және өткізіп жіберуге болады. Жауаптар мен түсіндірмелер — тек барлық емтихан аяқталғаннан кейін.",
    practiceBackToList: "Сынақ емтиханын таңдауға оралу",
    practiceTrialNotFound: "Мұндай сынақ емтиханы жоқ.",
    practiceLoading: "Сынақ жүктелуде…",
    practiceProgress: "Прогресс",
    practiceBack: "Артқа",
    practiceNext: "Келесі",
    practiceFinish: "Аяқтау",
    practiceFinishExam: "Емтиханды аяқтау",
    practiceOpenGrid: "Сұрақтар торы",
    practiceQuestionGrid: "Сұрақтар торы",
    practiceCloseGrid: "Жабу",
    practiceGridCurrent: "Ағымдағы",
    practiceGridAnswered: "Жауап берілді",
    practiceGridSkipped: "Жауапсыз",
    practiceAnswered: "Жауап берілді",
    practiceResults: "Нәтижелер",
    practiceResultsSubtitle: "Емтихан аяқталды. Төменде әр бөлім бойынша нәтиже.",
    practiceReviewWithAnswers: "Жауаптар мен түсіндірмелермен талдау",
    practiceReviewTitle: "Емтихан талдауы",
    practiceReviewSkipped: "Өткізілді",
    practiceBackToResults: "Нәтижеге оралу",
    practiceSectionScore: "Дұрыс: {correct} / {total} · жауап: {answered}",
    ...
    bankFilterAll: "Барлығы",
    bankFilterNis: "НИШ",
    bankFilterRfmsh: "РФМШ",
    bankFilterBil: "БИЛ",
    bankQuestions: "{value} сұрақ",
    bankOpen: "Ашу",
    bankQuestionLabel: "Сұрақ {number}",
    bankAnswerCorrect: "Дұрыс",
    bankAnswerWrong: "Қате",
    bankEnterAnswer: "Жауапты жазыңыз",
    bankAnswerPlaceholder: "Сіздің жауабыңыз",
    bankCheckAnswer: "Тексеру",
    bankExplanationTitle: "Түсіндірме",
    bankExplanationHint: "Шешім мен дұрыс жауап.",
    bankCorrectAnswerLabel: "Дұрыс жауап:",
    bankHowToSolve: "Шешу жолы",
    bankNoExplanation: "Бұл тапсырмаға түсіндірме әлі қосылмаған.",
    categoryArithmetic: "Арифметика",
    ...
    profileSubtitle: "Деректер мен прогресс автоматты түрде сақталады.",
    profileProgress: "Прогресс",
    profileProgressDesc: "Сынақ тесттерінің нәтижелері мен белсенділік осында көрсетіледі.",
    profileCorrect: "Дұрыс",
    profileIncorrect: "Қате",
    profileTotal: "Барлық жауаптар",
    profileNoProgress: "Прогресс осында көрінуі үшін сынақ тестін тапсырыңыз.",
