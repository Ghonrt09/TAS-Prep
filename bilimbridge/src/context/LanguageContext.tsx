...
const translations = {
  ru: {
    ...
    footerContactInstagram: "Instagram",
    footerContactTelegram: "Telegram",
    footerContactEmail: "Почта",
    ...
    practiceOneWayRule:
      "Пока задания пустые — позже вы загрузите файлы и задачи для каждого пробного экзамена.",
    ...
    practicePickAnswerToFinish: "Выберите ответ, чтобы перейти к следующему вопросу.",
    ...
    bankExplanationHint: "Как решать это задание",
    bankCorrectAnswerLabel: "Правильный ответ",
    bankHowToSolve: "Разбор решения",
    bankNoExplanation: "Пояснение к этому заданию скоро будет добавлено.",
    bankEnterAnswer: "Введите ответ",
    bankAnswerPlaceholder: "Ваш ответ",
    bankCheckAnswer: "Проверить",
    bankPracticeHint:
      "Выберите ответ — неверный подсветится красным, правильный зелёным. Справа появится объяснение.",
    ...
    profileSubtitle: "Ваш аккаунт и прогресс по тестам.",
    profileProgress: "Прогресс",
    profileProgressDesc: "Сводка по ответам в банке вопросов и пробных тестах.",
    profileTotal: "Всего ответов",
    profileCorrect: "Правильно",
    profileIncorrect: "Неправильно",
    profileNoProgress: "Пока нет сохранённого прогресса. Начните с банка вопросов или пробного теста.",
  ...
  kk: {
    ...
    practiceOneWayRule:
      "Әзірге тапсырмалар бос — кейін әр емтиханға файлдар мен тапсырмаларды жүктейсіз.",
    ...
    practicePickAnswerToFinish: "Келесі сұраққа өту үшін жауапты таңдаңыз.",
    ...
    bankExplanationHint: "Бұл тапсырманы қалай шешу керек",
    bankCorrectAnswerLabel: "Дұрыс жауап",
    bankHowToSolve: "Шешу жолы",
    bankNoExplanation: "Бұл тапсырмаға түсіндірме жақында қосылады.",
    bankEnterAnswer: "Жауапты енгізіңіз",
    bankAnswerPlaceholder: "Сіздің жауабыңыз",
    bankCheckAnswer: "Тексеру",
    bankPracticeHint:
      "Жауапты таңдаңыз — қате қызыл, дұрыс жасыл түспен белгіленеді. Оң жақта түсіндірме шығады.",
    categoryArithmetic: "Арифметика",
    ...
    authSignOut: "Шығу",
    profileTitle: "Профиль",
    profileSubtitle: "Аккаунт және тесттер бойынша прогресс.",
    profileProgress: "Прогресс",
    profileProgressDesc: "Сұрақтар банкі мен сынақ тесттері бойынша жауаптар.",
    profileTotal: "Барлық жауап",
    profileCorrect: "Дұрыс",
    profileIncorrect: "Қате",
    profileNoProgress:
      "Әзірге прогресс жоқ. Сұрақтар банкі немесе сынақ тестінен бастаңыз.",
