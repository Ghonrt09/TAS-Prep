...
const translations = {
  ru: {
    ...
    practiceHubSubtitle: "Выберите направление: НИШ, БИЛ или РФМШ. На каждом шаге показывается один вопрос.",
    practiceOpenTrial: "Начать пробный тест",
    practiceOneWayRule:
      "После перехода к следующему вопросу назад вернуться нельзя: прежние ответы сохраняются и изменить их нельзя.",
    practiceBackToList: "К выбору теста",
    practiceTrialNotFound: "Такого пробного теста нет.",
    practicePickAnswerToFinish: "Выберите вариант ответа — после этого появятся результаты.",
  ...
  kk: {
    ...
    practiceHubSubtitle: "Бағытты таңдаңыз: НИШ, БИЛ немесе РФМШ. Әр қадамда бір сұрақ көрсетіледі.",
    practiceOpenTrial: "Сынақ тестін бастау",
    practiceOneWayRule:
      "Келесі сұраққа өткеннен кейін артқа қайтуға болмайды: алдыңғы жауаптар сақталады және өзгерту мүмкін емес.",
    practiceBackToList: "Тест таңдауына оралу",
    practiceTrialNotFound: "Мұндай сынақ тесті жоқ.",
    practicePickAnswerToFinish: "Жауап нұсқасын таңдаңыз — содан кейін нәтиже көрінеді.",
    practiceProgress: "Прогресс",
    practiceBack: "Артқа",
    practiceNext: "Келесі",
