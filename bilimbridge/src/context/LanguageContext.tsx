...
const translations = {
  ru: {
    ...
    practiceOneWayRule:
      "После перехода к следующему вопросу назад вернуться нельзя: прежние ответы сохраняются и изменить их нельзя.",
  ...
  kk: {
    ...
    practiceOneWayRule:
      "Келесі сұраққа өткеннен кейін артқа қайтуға болмайды: бұрынғы жауаптар сақталады және өзгерту мүмкін емес.",
