...
Откройте терминал в папке проекта (`tasprep`) и выполните:
...
git remote add origin https://github.com/ВАШ-USERNAME/tasprep.git
...
3. Найдите `tasprep` и нажмите **"Import"**
